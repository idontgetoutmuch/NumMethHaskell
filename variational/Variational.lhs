...
>            )
> calcXdS biggR biggXs = -- trace (show xsums ++ "\n" ++ show xxbars)
>                              (nnK, xxbars, biggS)
>   where
>
...
This should work but gives a type error which I haven't had time to
investigate
...
https://github.com/HuwCampbell/grenade Also Justin Le's stuff
